...
SYSTEM_INSTRUCTION = (
    ...
    "provided context.\n"
    "You will be given a User Query and a set of highly specific Context "
    "Blocks retrieved from the RFC Atlas database.\n\n"
    ...
    "3. TEMPORAL LINEAGE WARNINGS: The IETF ecosystem is constantly "
    "evolving.\n"
    ...
    "outdated standards and point them to the active standard mentioned in "
    "the warning.\n"
    ...
    "   - If a context block contains a `[VERIFIED IETF ERRATA]` warning, you "
    'MUST prioritize the "CORRECTED TEXT".\n'
    "   - You MUST explicitly highlight to the user that a verified technical "
    "erratum exists for that specific rule.\n\n"
